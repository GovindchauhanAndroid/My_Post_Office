...
public class PinCode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.list_view_result2);
        progressDialog = new ProgressDialog(PinCode.this);
        ...
        if (getIntent().getExtras() != null) {
            URL = getIntent().getStringExtra("MyDat");
        }
        getData();
    }

    public void getData() {
        RequestQueue requestQueue = Volley.newRequestQueue(PinCode.this);
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, URL, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                arrayAdapter = new ArrayAdapter<String>(PinCode.this, android.R.layout.simple_list_item_1, arrayName);
                listView.setAdapter(arrayAdapter);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(PinCode.this, "Not Branch Find", Toast.LENGTH_LONG).show();
            }
        });
